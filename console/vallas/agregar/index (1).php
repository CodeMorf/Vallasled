                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div>
                    ...
                    <select id="provincia" name="provincia_id" class="inp-select">
                      ...
                      <option value="4">La Altagracia</option>
                      <option value="5">La Romana</option>
                      <option value="6">San Pedro de Macorís</option>
                      <option value="7">Puerto Plata</option>
                      <option value="8">La Vega</option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="flex gap-2">
                      <select id="zona" name="zona" class="inp-select">
                        <option value="">Seleccionar…</option>
                        <option>Zona Este</option><option>Zona Norte o Cibao</option><option>Zona Sur</option>
                      </select>
                      <button type="button" id="add-zone-btn" class="btn border border-[var(--border-color)] bg-[var(--input-bg)] text-[var(--text-secondary)]"><i class="fas fa-plus"></i></button>
                    </div>
                  </div>
