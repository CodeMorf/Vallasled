                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select id="proveedor" name="proveedor" class="w-full px-4 py-2 border rounded-lg bg-[var(--input-bg)] border-[var(--border-color)]">
                      <?php
                      $opts = [
                        1=>'Fox Publicidad',3=>'VALLAS PAUL',4=>'Grupoohla srl',5=>'Alfrit srl',
                        7=>'Vallas Universal',8=>'admin',9=>'Captiva',10=>'Colorin'
                      ];
            ...
            <div class="lg:col-span-1 space-y-6">
              ...
              <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <div class="relative inline-block w-10 mr-2 align-middle">
                    <input type="checkbox" name="ads" id="toggle-ads"
                ...
                <div id="ads-details-container" class="<?= $adsChecked ? '' : 'hidden' ?> space-y-4">
                  <div class="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" id="ads-start" name="ads_start" value="<?= $adsStartVal ?>"
                             class="w-full px-3 py-2 text-sm border rounded-lg bg-[var(--input-bg)] border-[var(--border-color)]">
                    </div>
                    <div>
                      <label class="block text-xs font-medium mb-1">Fin ADS</label>
                      <input type="text" id="ads-end" name="ads_end" value="<?= $adsEndVal ?>"
                             class="w-full px-3 py-2 text-sm border rounded-lg bg-[var(--input-bg)] border-[var(--border-color)]">
                    </div>
                  </div>
                  <div class="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="number" step="0.01" id="monto-pagado" name="monto_pagado" value="<?= $adsMonto ?>"
                             class="w-full px-3 py-2 text-sm border rounded-lg bg-[var(--input-bg)] border-[var(--border-color)]">
                    </div>
                    <div>
                      <label class="block text-xs font-medium mb-1">Orden</label>
                      <input type="number" id="orden" name="orden" value="<?= $adsOrden ?>"
                             class="w-full px-3 py-2 text-sm border rounded-lg bg-[var(--input-bg)] border-[var(--border-color)]">
                    </div>
                  </div>
                </div>
...
document.addEventListener('DOMContentLoaded', ()=>{
  // provincia seleccionada tras cargar por AJAX
